...
(function(process) {
  (function(w) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = w() : "function" === typeof define && define.amd ? define([], w) : ("undefined" !== typeof window ? window : "undefined" !== typeof global ? global : "undefined" !== typeof self ? self : this).Rx = w();
  })(function() {
    return function a(b, f, g) {
      ...
      2: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          e.prototype._subscribe = function(d) {
            var c = a.prototype._subscribe.call(this, d);
            c && !c.isUnsubscribed && d.next(this._value);
            return c;
          };
          e.prototype._next = function(d) {
            a.prototype._next.call(this, this._value = d);
          };
          e.prototype._error = function(d) {
            this.hasErrored = !0;
            a.prototype._error.call(this, this.errorValue = d);
          };
          return e;
        }(b.Subject);
        f.BehaviorSubject = a;
      ...
      5: [function(a, b, f) {
        ...
        a = function() {
          ...
          a.prototype.subscribe = function(a, d, c) {
            ...
            a.add(m ? m.call(a, this) : this._subscribe(a));
      ...
      7: [function(a, b, f) {
        ...
        a = function() {
          ...
          a.prototype.call = function(a, b) {
            return b._subscribe(new g.Subscriber(a));
          };
          return a;
        }();
        f.Operator = a;
      ...
      9: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          d.prototype._subscribe = function(c) {
            ...
            for (var n = -1,
                b = d.length; ++n < b && !c.isUnsubscribed; )
              c.next(d[n].value);
          ...
          d.prototype._trimBufferThenGetEvents = function(a) {
            for (var d = this.bufferSize,
                e = this._windowTime,
                b = this.events,
                h = b.length,
                f = 0; f < h && !(a - b[f].time < e); )
              f += 1;
            h > d && (f = Math.max(f, h - d));
            0 < f && b.splice(0, f);
            return b;
          };
          return d;
          ...
          b.prototype.unsubscribe = function() {
            if (!this.isUnsubscribed) {
              ...
              var a = this.subject,
                  e = a.observers;
              this.subject = null;
              e && 0 !== e.length && !a.isUnsubscribed && (a = e.indexOf(this.observer), -1 !== a && e.splice(a, 1));
            }
          };
          return b;
      ...
      119: [function(a, b, f) {
        ...
        a = function(a) {
          function e(d, c, e, b) {
            ...
            this.arrayLike = d;
            this.scheduler = b;
            c || b || 1 !== d.length || (this._isScalar = !0, this.value = d[0]);
            c && (this.mapFn = c.bind(e));
          }
          g(e, a);
          e.create = function(a, c, m, b) {
            var h = a.length;
            return 0 === h ? new l.EmptyObservable : 1 !== h || c ? new e(a, c, m, b) : new k.ScalarObservable(a[0], b);
          };
          e.dispatch = function(a) {
            var c = a.arrayLike,
                ...
                h = a.mapFn,
                f = a.subscriber;
            f.isUnsubscribed || (e >= b ? f.complete() : (c = h ? h(c[e], e) : c[e], f.next(c), a.index = e + 1, this.schedule(a)));
          };
          e.prototype._subscribe = function(a) {
            var c = this.arrayLike,
                ...
                h = c.length;
            if (b)
              return b.schedule(e.dispatch, 0, {
                arrayLike: c,
                index: 0,
                length: h,
                mapFn: m,
            ...
            for (b = 0; b < h && !a.isUnsubscribed; b++) {
              var f = m ? m(c[b], b) : c[b];
              a.next(f);
            }
            a.complete();
      ...
      120: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          d.of = function() {
            ...
            var b = a.length;
            return 1 < b ? new d(a, e) : 1 === b ? new k.ScalarObservable(a[0], e) : new l.EmptyObservable(e);
          };
          ...
          d.prototype._subscribe = function(a) {
            var e = this.array,
                ...
                h = this.scheduler;
            if (h)
              return h.schedule(d.dispatch, 0, {
                array: e,
                index: 0,
                count: b,
                subscriber: a
              });
            for (h = 0; h < b && !a.isUnsubscribed; h++)
              a.next(e[h]);
            a.complete();
          };
          return d;
      ...
      121: [function(a, b, f) {
        function g(a) {
          var b = this,
              h = a.source;
          a = a.subscriber;
          var f = h.callbackFunc,
              g = h.args,
              t = h.scheduler,
              q = h.subject;
          if (!q) {
            var q = h.subject = new c.AsyncSubject,
                v = function x() {
                  for (var a = [],
                  ...
                  var m = x.source,
                      c = m.selector,
                      m = m.subject;
                  c ? (a = e.tryCatch(c).apply(this, a), a === d.errorObject ? b.add(t.schedule(l, 0, {
                    err: d.errorObject.e,
                    subject: m
            ...
            v.source = h;
            e.tryCatch(f).apply(this, g.concat(v)) === d.errorObject && q.error(d.errorObject.e);
          }
          b.add(q.subscribe(a));
        }
        function k(a) {
            ...
            var q = h.subject = new c.AsyncSubject,
                v = function x() {
                  ...
                  var m = x.source,
                      ...
                      m = m.subject,
                      h = a.shift();
                  h ? m.error(h) : c ? (a = e.tryCatch(c).apply(this, a), a === d.errorObject ? b.add(t.schedule(l, 0, {
                    err: d.errorObject.e,
                    subject: m
                  })) : b.add(t.schedule(k, 0, {
                    value: a,
      ...
      128: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          d.setupSubscription = function(a, e, b, f) {
            var l;
            if (a && "[object NodeList]" === a.toString() || a && "[object HTMLCollection]" === a.toString())
              for (var k = 0,
                  g = a.length; k < g; k++)
                d.setupSubscription(a[k], e, b, f);
            else
              a && "function" === typeof a.addEventListener && "function" === typeof a.removeEventListener ? (a.addEventListener(e, b), l = function() {
                return a.removeEventListener(e, b);
              }) : a && "function" === typeof a.on && "function" === typeof a.off ? (a.on(e, b), l = function() {
                return a.off(e, b);
              }) : a && "function" === typeof a.addListener && "function" === typeof a.removeListener && (a.addListener(e, b), l = function() {
                return a.removeListener(e, b);
              });
            f.add(new h.Subscription(l));
          };
          d.prototype._subscribe = function(a) {
            var e = this.selector;
        ...
        a = function(a) {
          ...
          d.prototype._subscribe = function(a) {
            var d = this.removeHandler,
                e = this.selector,
                b = e ? function(d) {
                  var b = l.tryCatch(e).apply(null, arguments);
                  b === h.errorObject ? a.error(b.e) : a.next(b);
                } : function(d) {
                  a.next(d);
                },
      ...
      130: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          g(b, a);
          b.create = function(a, f, g, t) {
            var q = null,
                z = null;
            l.isFunction(f) ? (q = t || null, z = f) : e.isScheduler(q) && (q = f);
            if (null != a) {
              ...
              if ("function" === typeof a[u.$$iterator] || "string" === typeof a)
          ...
          b.prototype._subscribe = function(a) {
            var c = this.ish,
                d = this.scheduler;
            return null == d ? c[r.$$observable]().subscribe(a) : c[r.$$observable]().subscribe(new t.ObserveOnSubscriber(a, d, 0));
          };
          return b;
        }(p.Observable);
        f.FromObservable = a;
        ...
        a = function(a) {
          ...
          b.dispatch = function(a) {
            var d = a.index,
                ...
                m = a.iterator,
                n = a.subscriber;
            a.hasError ? n.error(a.error) : (m = m.next(), m.done ? n.complete() : (b ? (m = h.tryCatch(b).call(e, m.value, d), m === c.errorObject ? (a.error = c.errorObject.e, a.hasError = !0) : (n.next(m), a.index = d + 1)) : (n.next(m.value), a.index = d + 1), n.isUnsubscribed || this.schedule(a)));
          };
          b.prototype._subscribe = function(a) {
            var d = 0,
                e = this.iterator,
              ...
              function a(c, d, e) {
                ...
                if (void 0 === e)
                  if (e = +c.length, isNaN(e))
                    ...
                    var b;
                    b = +e;
                    b = 0 === b ? b : isNaN(b) ? b : 0 > b ? -1 : 1;
                    e = b * Math.floor(Math.abs(e));
                    e = 0 >= e ? 0 : e > r ? r : e;
                  }
                this.arr = c;
                this.idx = d;
        ...
        a = function(a) {
          ...
          b.dispatch = function(a) {
            var e = a.start,
                d = a.index,
                c = a.subscriber;
            d >= a.count ? c.complete() : (c.next(e), c.isUnsubscribed || (a.index = d + 1, a.start = e + 1, this.schedule(a)));
          };
          b.prototype._subscribe = function(a) {
            var e = 0,
                d = this.start,
      ...
      158: [function(a, b, f) {
        ...
        var h = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new e(a, this.delay, this.scheduler));
          };
          return a;
        }(),
            e = function(a) {
      ...
      159: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.closingNotifier));
          };
          return a;
        }(),
            h = function(a) {
      ...
      161: [function(a, b, f) {
        ...
        var d = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new c(a, this.bufferTimeSpan, this.bufferCreationInterval, this.scheduler));
          };
          return a;
        }(),
            c = function(a) {
              function c(d, e, b, h) {
                ...
                if (null !== b && 0 <= b) {
                  ...
                  this.add(h.schedule(l, e, {
                    subscriber: this,
                    buffer: d
                  }));
                  this.add(h.schedule(k, b, n));
                } else
                  this.add(h.schedule(g, e, {
                    subscriber: this,
                    buffer: d,
                    bufferTimeSpan: e
                  }));
      ...
      162: [function(a, b, f) {
        ...
        var e = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new d(a, this.openings, this.closingSelector));
          };
          return a;
        }(),
            d = function(a) {
      ...
      165: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.selector, this.caught));
          };
          return a;
        }(),
            l = function(a) {
      ...
      173: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.durationSelector));
          };
          return a;
        }(),
            h = function(a) {
      ...
      180: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.nextOrObserver, this.error, this.complete));
          };
          return a;
        }(),
            h = function(a) {
      ...
      183: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.select, this.thisArg));
          };
          return a;
        }(),
            l = function(a) {
      ...
      184: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.finallySelector));
          };
          return a;
        }(),
            h = function(a) {
      ...
      185: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.predicate, this.resultSelector, this.defaultValue, this.source));
          };
          return a;
        }(),
            h = function(a) {
              function d(c, d, b, f, h) {
                a.call(this, c);
                this.predicate = d;
                this.resultSelector = b;
                this.defaultValue = f;
          ...
          return a;
            ...
            m = function(a) {
              ...
              c.prototype._group = function(a, c) {
                ...
                var m = b.get(c);
                m || (b.set(c, m = new h.Subject), b = new r(c, m, this), this.durationSelector && this._selectDuration(c, m), this.destination.next(b));
                this.elementSelector ? this._selectElement(a, m) : this.tryGroupNext(a, m);
              };
              c.prototype._selectElement = function(a, c) {
                var d;
                try {
              ...
              c.prototype._selectDuration = function(a, c) {
                var d;
                try {
                  d = this.durationSelector(new r(a, c));
                } catch (e) {
                  this.error(e);
                  return;
                }
                this.add(d.subscribe(new n(a, c, this)));
              };
              c.prototype.tryGroupNext = function(a, c) {
            ...
            r = function(a) {
              ...
              c.prototype._subscribe = function(a) {
                var c = new k.Subscription,
                    ...
                    e = this.groupSubject;
                d && !d.isUnsubscribed && c.add(new u(d));
                c.add(e.subscribe(a));
                return c;
              };
              return c;
            }(l.Observable);
        f.GroupedObservable = r;
        var u = function(a) {
          function c(d) {
            a.call(this);
            this.parent = d;
      ...
      194: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.concurrent));
          };
          return a;
        }();
      ...
      195: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.project, this.resultSelector, this.concurrent));
          };
          return a;
        }();
        ...
        var h = function(a) {
          ...
          d.prototype._innerSub = function(a, d, b) {
            this.add(k.subscribeToResult(this, a, d, b));
          };
          d.prototype._complete = function() {
            this.hasCompleted = !0;
            0 === this.active && 0 === this.buffer.length && this.destination.complete();
          ...
          d.prototype.notifyNext = function(a, d, b, e, f) {
            this.resultSelector ? this._notifyResultSelector(a, d, b, e) : this.destination.next(d);
          };
          d.prototype._notifyResultSelector = function(a, d, b, e) {
            var f;
            try {
      ...
      196: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.ish, this.resultSelector, this.concurrent));
          };
          return a;
        }();
        ...
        var h = function(a) {
          ...
          d.prototype._next = function(a) {
            if (this.active < this.concurrent) {
              var d = this.resultSelector,
                  ...
                  f = this.destination;
              this.active++;
              this._innerSub(e, f, d, a, b);
            } else
              this.buffer.push(a);
          };
          d.prototype._innerSub = function(a, d, b, e, f) {
            this.add(k.subscribeToResult(this, a, e, f));
          };
          d.prototype._complete = function() {
            this.hasCompleted = !0;
            0 === this.active && 0 === this.buffer.length && this.destination.complete();
          ...
          d.prototype.notifyNext = function(a, d, b, e, f) {
            f = this.destination;
            this.resultSelector ? this.trySelectResult(a, d, b, e) : f.next(d);
          };
          d.prototype.trySelectResult = function(a, d, b, e) {
      ...
      198: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new h(a, this.scheduler, this.delay));
          };
          return a;
        }();
      ...
      206: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.project, this.seed));
          };
          return a;
        }();
        f.ReduceOperator = k;
      ...
      207: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.count, this.source));
          };
          return a;
        }(),
            h = function(a) {
      ...
      210: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.notifier));
          };
          return a;
        }(),
            h = function(a) {
      ...
      214: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.predicate, this.source));
          };
          return a;
        }(),
            h = function(a) {
      ...
      221: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.project, this.resultSelector));
          };
          return a;
        }(),
            h = function(a) {
      ...
      222: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.observable, this.resultSelector));
          };
          return a;
        }(),
            h = function(a) {
      ...
      233: [function(a, b, f) {
        ...
        var h = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new e(a, this.windowBoundaries));
          };
          return a;
        }(),
            e = function(a) {
      ...
      234: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new h(a, this.windowSize, this.startWindowEvery));
          };
          return a;
        }(),
            h = function(a) {
              ...
              b.prototype._next = function(a) {
                for (var b = 0 < this.startWindowEvery ? this.startWindowEvery : this.windowSize,
                  ...
                  f[g].next(a);
                a = this.count - e + 1;
                0 <= a && 0 === a % b && f.shift().complete();
                0 === ++this.count % b && (b = new k.Subject, f.push(b), d.add(b), d.next(b));
              };
              b.prototype._error = function(a) {
        ...
        var c = function() {
          ...
          return a;
            ...
            m = function(a) {
              ...
              b.prototype.notifyNext = function(a, b, c, f, g) {
                if (a === this.openings) {
                  f = h.tryCatch(this.closingSelector)(b);
                  if (f === e.errorObject)
                  ...
                  f = d.subscribeToResult(this, f, c);
                  f.isUnsubscribed ? this.closeWindow(this.contexts.length - 1) : (f.context = c, b.add(f));
                  this.destination.next(a);
                } else
      ...
      237: [function(a, b, f) {
        ...
        var d = function() {
          ...
          a.prototype.call = function(a, b) {
            return b._subscribe(new c(a, this.closingSelector));
          };
          return a;
        }(),
            c = function(a) {
              ...
              b.prototype.openWindow = function(a) {
                ...
                b === h.errorObject ? (a = h.errorObject.e, this.destination.error(a), this.window.error(a)) : (this.add(this.closingNotification = e.subscribeToResult(this, b)), this.add(a));
              };
              return b;
            }(b.OuterSubscriber);
      }, {
      ...
      238: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, b) {
            return b._subscribe(new h(a, this.observables, this.project));
          };
          return a;
        }(),
            h = function(a) {
              function b(c, d, f) {
                ...
                for (f = 0; f < c; f++) {
                  var h = d[f];
                  this.add(k.subscribeToResult(this, h, h, f));
                }
              }
              g(b, a);
        ...
        var n = function(a) {
          ...
          b.prototype._next = function(a) {
            var b = this.iterators,
                d = this.index++;
            h.isArray(a) ? b.push(new u(a)) : "function" === typeof a[c.$$iterator] ? b.push(new r(a[c.$$iterator]())) : b.push(new p(this.destination, this, a, d));
          };
          b.prototype._complete = function() {
          ...
          b.prototype.checkIterators = function() {
            ...
            this.project ? this._tryProject(h) : c.next(h);
            f && c.complete();
          };
          b.prototype._tryProject = function(a) {
            var b;
          ...
          return a;
            ...
            p = function(a) {
              ...
              b.prototype.subscribe = function(a, b) {
                return d.subscribeToResult(this, this.observable, this, b);
              };
              return b;
            }(e.OuterSubscriber);
      }, {
      ...
      271: [function(a, b, f) {
        var g = a("./root"),
            ...
            c = a("../InnerSubscriber");
        f.subscribeToResult = function(a, b, f, u) {
          var p = new c.InnerSubscriber(a, f, u);
          if (!p.isUnsubscribed) {
            ...
            if (k.isArray(b)) {
              ...
              if ("function" === typeof b[e.$$iterator]) {
                ...
                if (b = b[d.$$observable](), "function" !== typeof b.subscribe)
                  ...
                  return b.subscribe(new c.InnerSubscriber(a, f, u));
              else
